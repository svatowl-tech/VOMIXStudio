...
EMSCRIPTEN_BINDINGS(daw_core_module) {
    ...
    class_<Track>("Track")
        ...
        .property("deClicker", +[](Track& t) -> DeClicker* { return &t.deClicker; }, allow_raw_pointers())
        .property("dePlosive", +[](Track& t) -> DePlosive* { return &t.dePlosive; }, allow_raw_pointers())
        .property("noiseGate", +[](Track& t) -> NoiseGate* { return &t.noiseGate; }, allow_raw_pointers())
        .property("eq", +[](Track& t) -> ParametricEQ3Band* { return &t.eq; }, allow_raw_pointers())
        .property("deEsser", +[](Track& t) -> DeEsser* { return &t.deEsser; }, allow_raw_pointers())
        .property("compressor", +[](Track& t) -> SoftKneeCompressor* { return &t.compressor; }, allow_raw_pointers())
        .property("autoDucker", +[](Track& t) -> AutoDucker* { return &t.autoDucker; }, allow_raw_pointers())
